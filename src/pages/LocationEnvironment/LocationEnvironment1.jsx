...
const LocationEnvironment1 = () => {
	...
	return (
		<div className={styles.container}>
					...
					<Helmet>
					<title>대전 도안 벽산블루밍 - 입지안내</title>
					<meta name="description" content="대전 도안 벽산블루밍의 입지 정보를 확인하세요. 뛰어난 교통망, 생활 인프라, 교육 및 쇼핑 시설 등 편리한 주변 환경을 소개하며, 평택의 중심에서 누릴 수 있는 생활의 편리함과 가치를 제공합니다" />
					<meta property="og:title" content="대전 도안 벽산블루밍 - 입지안내" />
					<meta property="og:description" content="대전 도안 벽산블루밍의 입지 정보를 확인하세요. 뛰어난 교통망, 생활 인프라, 교육 및 쇼핑 시설 등 편리한 주변 환경을 소개하며, 평택의 중심에서 누릴 수 있는 생활의 편리함과 가치를 제공합니다" />
					...
					<meta name="twitter:title" content="대전 도안 벽산블루밍 - 입지안내" />
					<meta name="twitter:description" content="대전 도안 벽산블루밍의 입지 정보를 확인하세요. 뛰어난 교통망, 생활 인프라, 교육 및 쇼핑 시설 등 편리한 주변 환경을 소개하며, 평택의 중심에서 누릴 수 있는 생활의 편리함과 가치를 제공합니다" />
			...
			<h1 className={styles.screenReaderOnly}>대전 도안 벽산블루밍 - 입지안내</h1>
			<p className={styles.screenReaderOnly}>대전 도안 벽산블루밍의 입지 정보를 확인하세요. 뛰어난 교통망, 생활 인프라, 교육 및 쇼핑 시설 등 편리한 주변 환경을 소개하며, 평택의 중심에서 누릴 수 있는 생활의 편리함과 가치를 제공합니다
			</p>

			<div className={styles.textBox}>
				<div>살수록 높아질 코오롱 스카이앤</div>
				<div>도시를 압도할 자부심 대전 도안 벽산블루밍</div>
			</div>

			{/* <img src={page1} className={styles.image2} alt="대전 도안 벽산블루밍-image1" /> */}
