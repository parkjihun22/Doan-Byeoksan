...
const LocationEnvironment1 = () => {
	...
	return (
		<div className={styles.container}>
			...
			<h1 className={styles.screenReaderOnly}>대전 도안 벽산블루밍 - 프리미엄</h1>
			<p className={styles.screenReaderOnly}>대전 도안 벽산블루밍의 차별화된 프리미엄을 만나보세요. 고급스러운 디자인, 첨단 기술이 결합된 설계, 입주민을 위한 특별한 혜택 등을 통해 푸르지오만의 독보적인 가치를 제공합니다.
			</p>
			...
			{/* <img src={page1} className={styles.image3} alt="대전 도안 벽산블루밍프리미엄-image1" /> */}
			<Ready />
